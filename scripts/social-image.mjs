...
try {
  ...
  await page.evaluate(async () => {
    ...
    document.body.innerHTML = `<div id="view"></div><section id="cover"><div class="social-brand"><img src="/favicon.svg" width="64" height="64"/><span>chillhill</span></div><div><p class="kicker">A LITTLE DOWNHILL ESCAPE</p><h1>Take the<br/><em>scenic route.</em></h1><p class="copy">A little car. An endless road.<br/>Your own pace.</p></div><div class="social-bottom"><span>PLAY IN YOUR BROWSER</span><span>↗</span></div></section>`;
    const style = document.createElement('style');
    style.textContent = `*{box-sizing:border-box}body{margin:0;background:#eff0e5;color:#344539;overflow:hidden}#view{position:absolute;inset:0 0 0 365px}#cover{position:absolute;inset:0 auto 0 0;width:465px;padding:38px 34px 32px 38px;background:#f3f1e7;border-radius:0 32px 32px 0;display:flex;flex-direction:column;justify-content:space-between;box-shadow:14px 0 40px #273c2314}.social-brand{display:flex;align-items:center;gap:14px;font:700 38px 'DM Sans Variable',sans-serif;letter-spacing:-2px}.social-brand img{border-radius:18px}.kicker{font:600 10px 'DM Sans Variable',sans-serif;letter-spacing:3px;color:#647555;margin:0 0 20px}#cover h1{font:400 65px/.99 'DM Serif Display',Georgia,serif;letter-spacing:-2px;margin:0}#cover em{color:#61734c;font-weight:400;white-space:nowrap}.copy{font:400 17px/1.7 'DM Sans Variable',sans-serif;margin:24px 0 0;color:#65715e}.social-bottom{display:flex;justify-content:space-between;align-items:center;border-top:1px solid #cbd1bf;padding-top:18px;font:600 10px 'DM Sans Variable',sans-serif;letter-spacing:2px}.social-bottom span:last-child{font-size:27px;line-height:1}`;
  ...
  await page.screenshot({ path: 'public/social/chillhill-coast-v1.png' });
  await page.evaluate(() => {
  ...
  console.log('Rendered 1200×630 coastal social card and 180×180 logo from the game assets.');
} finally {
  await browser.close();
}
